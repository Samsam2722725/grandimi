...
export const mockPredictHeight = async (data) => {
  return new Promise((resolve) => {
    setTimeout(() => {
      // Le serveur utilise Khamis-Roche croisé avec le percentile OMS ; ce
      // mock ne sert qu au developpement hors ligne et reste approximatif.
      ...
      resolve({
        ...
        model_used: 'Khamis-Roche + percentile OMS — mock approximatif',
